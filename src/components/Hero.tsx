        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex items-center space-x-4 mb-6">
              <img src={logo} alt="Dandy Designs Logo" className="w-16 h-16 animate-float" />
              <div>
                <h1 className="heading-luxury text-3xl lg:text-5xl">
                  DANDY
                </h1>
                <h1 className="heading-luxury text-3xl lg:text-5xl -mt-2">
                  DESIGNS
                </h1>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-glow transition-all duration-500 hover-lift">
              <img
                src={heroImage}
            ...
            <div className="absolute -top-6 -right-6 glass-effect rounded-2xl p-6 animate-float" style={{animationDelay: '2s'}}>
              <div className="text-center">
