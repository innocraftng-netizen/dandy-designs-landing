...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-luxury hover:shadow-glow",
        ...
        luxury: "bg-gradient-gold text-primary-foreground hover:shadow-glow transform hover:scale-105 transition-all duration-300",
        hero: "bg-primary text-primary-foreground hover:bg-primary-glow shadow-luxury hover:shadow-glow transform hover:scale-105",
        glass: "glass-effect text-foreground hover:bg-white/90 dark:hover:bg-black/90 border border-white/20",
      },
      size: {
