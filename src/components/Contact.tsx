...
import { Phone, Instagram, MapPin, Clock, Mail, Send, Sparkles } from "lucide-react"
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Call Us",
      info: ["07012463004", "09059180169"],
      action: "tel:07012463004"
    },
    {
      icon: Instagram,
      title: "Follow Us",
      info: ["@dandy_designs_fashion_house", "@dandydesignsfashionhous1"],
      action: "https://instagram.com/dandy_designs_fashion_house"
    },
    {
      icon: MapPin,
      title: "Visit Us",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Ready to elevate your style? Contact us today for a personalized consultation and let's bring your fashion vision to life.
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full h-12 px-3 py-2 bg-background border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-ring">
                      <option value="">Select a service</option>
                      <option value="corporate">Corporate Wears</option>
                      <option value="gown">Evening Gowns</option>
                      <option value="separates">Skirts & Blouses</option>
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-6">
              {contactInfo.map((contact, index) => (
                <Card key={index} className="hover-lift shadow-soft hover:shadow-luxury transition-all duration-500 group">
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-12 h-12 bg-gradient-gold rounded-xl flex items-center justify-center group-hover:shadow-glow transition-all duration-300">
