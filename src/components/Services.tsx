      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            From boardroom to ballroom, we create exceptional pieces that reflect your unique personality and elevate your confidence.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            <Card key={index} className="hover-lift bg-card border-0 shadow-soft hover:shadow-luxury transition-all duration-500 group">
              <CardContent className="p-8">
                <div className="text-center space-y-6">
                  
                  {/* Icon */}
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-gold rounded-2xl group-hover:shadow-glow transition-all duration-300">
        ...
        <div className="text-center mt-16">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Schedule a consultation with our expert designers and discover how we can bring your fashion vision to life.
            </p>
